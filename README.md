...
- **주제별 핵심단어** (하단 메뉴 · 메인 화면): 지금까지 만들어 둔 이야기를 모두 훑어 주제(가족·관계, 돈·재산, 일·직장,
  감정·마음, 법·갈등, 건강·병원 …)를 나누고, **주제마다 핵심단어 20개를 자동으로 뽑아** 그 단어가 나오는 문장을 모아 줍니다.
  단어 · 문장(듣기·연속 듣기·익힘 표시) · 퀴즈는 이야기 학습과 똑같이 쓸 수 있고, 문장에는 어느 이야기에서 왔는지 함께 보여 줍니다.
  뜻이 없는 단어는 열 때 한 번만 받아 저장해 두고 다시 씁니다.
- **단어장**: 저장한 단어 플래시카드 복습
